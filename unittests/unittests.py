...
class TestAdd(TestCase):
    ...
    def test_medium_add(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(333, 333, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(333, 333, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "add")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestAbs(TestCase):
    ...
    def test_medium_abs(self):
        dp_mat, nc_mat = rand_dp_nc_matrix(333, 300, seed=0)
        is_correct, speed_up = compute([dp_mat], [nc_mat], "abs")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestNeg(TestCase):
    ...
    def test_large_neg(self):
        dp_mat, nc_mat = rand_dp_nc_matrix(10000, 10002, seed=0)
        is_correct, speed_up = compute([dp_mat], [nc_mat], "neg")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestMul(TestCase):
    ...
    def test_medium_mul(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(3000, 1000, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(1000, 3000, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
